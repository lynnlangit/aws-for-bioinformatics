...
|[Variant Transforms](https://github.com/googlegenomics/AWS-variant-transforms)| transform and load vcf files into BigQuery    | end    | can embed in Jupyter notebooks | Google Cloud   |
