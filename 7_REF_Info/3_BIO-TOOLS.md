...
|[fgbio](https://https://github.com/fulcrumgenomics/fgbio#list-of-tools)| open source tools which operate on read-level data (ex. FASTQ, SAM, or BAM) or variant-level data (ex. VCF or BCF)              | all   | see GitHub Repo | Fulcrum Genomics | |
